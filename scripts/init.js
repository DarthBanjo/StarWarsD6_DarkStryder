(() => {
  const adventureName = 'The Darkstryder Campaign';
  const moduleName = 'swd6-darkstryder';
   ...
   *   const creaturePacks = [];
   */
  const creaturePacks = ["swd6-darkstryder.actors","dnd5e.monsters"];
  /**
   ...
   *   const journalPacks = [];
   */
  const journalPacks = ["swd6-darkstryder.journals"];
  /**
   ...
   *   const playlistPacks = [];
   */
  const playlistPacks = ["swd6-darkstryder.playlists"];
  /**
   ...
   */
  const additionalModulePacks = ["swd6-darkstryder"];
